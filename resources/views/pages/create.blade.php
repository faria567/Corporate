...
@section('title','Product')
    ...
    <div class="col-12 mt-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="content_title1" name="content_title1" placeholder="Enter content title" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content_des1" name="content_des1" rows="4" placeholder="Enter content description" required></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="content_title2" name="content_title2" placeholder="Enter content title" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content_des2" name="content_des2" rows="4" placeholder="Enter content description" required></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="content_title3" name="content_title3" placeholder="Enter content title" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content_des3" name="content_des3" rows="4" placeholder="Enter content description" required></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="conclusion" name="conclusion" rows="4" placeholder="Enter conclusion" required></textarea>
        </div>

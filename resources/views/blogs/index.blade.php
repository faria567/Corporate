      ...
      <div class="search-option rounded bg-white" style="border: 1px solid lightgray; border-top: none" >
        <form action="" method="get" class="row text-start pt-4">
          ...
          <div class=" col-md-4 text-start text-md-end" >
            <a class="btn btn-success my-3 my-md-0 me-2 "  href="{{route('blog.create')}}"><i class="fa fa-plus"></i> Add new</a>
                        ...
                        cellspacing="0" width="100%">
                            ...
                            <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td >{{$blog->content}}</td>
                                      <td ><img style="width:150px; height:100px;" src="{{ asset('uploads/'.$blog->image )}}" alt=""></td>
                                          <td>
                                              <form action="{{route('blog.destroy',$blog->id)}}"  method="Post">
                                             
                                              <a href="{{route('blog.edit',$blog->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
                                              @csrf
                                              @method('DELETE')

      ...
      <div class="search-option rounded bg-white" style="border: 1px solid lightgray; border-top: none" >
        <form action="" method="get" class="row text-start pt-4">
          ...
          <div class=" col-md-4 text-start text-md-end" >
            <a class="btn btn-success my-3 my-md-0 me-2 "  href="{{route('partner.create')}}"><i class="fa fa-plus"></i> Add new</a>
          </div>
        </form>
      </div>
    </div>
                        ...
                        cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$partner->name}}</td>
                                    <td>{{$partner->url}}</td>
                                    <td> <img src="{{ asset('/partner/'. $partner->logo)}}" alt="" height="50" width="80"></td>
                                    <td>
                                        <a href="{{route('partners.edit', $partner->id)}}" class="btn btn-success btn-sm" title="Edit partner">
